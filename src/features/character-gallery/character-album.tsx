...
const CharacterAlbum = ({
  ...
  // xl:h-[clamp(1000px,160vh,1500px)] lg:h-[clamp(800px,110vh,1500px)] md:h-[clamp(1200px,90vh,1500px)] sm:h-[clamp(1000px,250vh,1300px)] h-[clamp(900px,105vh,1300px)] grid xl:grid-rows-[10vh_130vh] lg:grid-rows-[10vh_100vh] md:grid-rows-[10vh_70vh] sm:grid-rows-[20vh_150vh] grid-rows-[10vh_95vh]
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="flex sm:justify-center pb-[10vh]">
