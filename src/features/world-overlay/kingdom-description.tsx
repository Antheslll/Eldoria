...
const KingdomDescription = ({
  ...
  if (height < 600) {
    return (
      <div className={` bg-black h-auto grid grid-rows-[25vh_1vh_70vh] `}>
        <div className=" flex items-end pl-[5%]">
          <h3
            className="xl:text-[3.7vw] lg:text-[3.7vw] md:text-[8vw] sm:text-[3.7vw] text-[10vw] font-pirata "
            style={{ color: `${color}` }}
          >
            {kingdom}
          </h3>
        ...
        <div className="pl-[5%] ">
          <div
            className="w-[90%] md:h-[2px]"
            style={{ backgroundColor: `${color}` }}
          ></div>
        </div>
        <div className="xl:pl-5 lg:pl-5 md:pl-7.5 xl:pr-8 lg:pr-8 md:pr-[7vw] sm:pl-2.5 sm:pr-5 pl-5 pr-10 pt-2 ">
          <p
            className=" font-eb-garamond xl:text-[1vw] lg:text-[1vw] md:text-[1.8vw] sm:text-[1vw] text-[2.5vw] text-justify"
            style={{ color: `${color}` }}
          >
    ...
    return (
      <div className={` bg-black h-auto grid grid-rows-[15vh_1vh_70vh] `}>
        <div className=" flex items-end pl-[5%]">
          <h3
